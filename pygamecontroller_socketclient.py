...
# null zone where cursor position doesn't affect x or y
...
while not done:
	...
	# draw null zone where cursor position doesn't affect x or y
	...
	if b2==0:
		...
		# left,right buttons - increase,decrease z
		if b1==1 and b3==0:
